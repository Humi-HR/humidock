...
Determine the seeded token_type from the token_type table for an API token.
Using the token_type id, search in the token table for the generated api token.
Add this token to your admin tool .env file
